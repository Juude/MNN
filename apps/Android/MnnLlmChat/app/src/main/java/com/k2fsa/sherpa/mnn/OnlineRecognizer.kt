...
fun getModelConfig(type: Int): OnlineModelConfig? {
    when (type) {
        0 -> {
            val modelDir = "${ASR_MODEL_DIR}/sherpa-mnn-streaming-zipformer-bilingual-zh-en-2023-02-20"
        ...
        1 -> {
            val modelDir = "${ASR_MODEL_DIR}/sherpa-mnn-streaming-zipformer-en-2023-02-21"
            return OnlineModelConfig(
                transducer = OnlineTransducerModelConfig(
